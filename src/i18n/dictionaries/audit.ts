...
const it = {
  ...
  reportTakeOver: 'Segnalazione presa in carico',
  reportResolve: 'Segnalazione risolta',
  reportDismiss: 'Segnalazione respinta',
...
const en: Record<keyof typeof it, string> = {
  ...
  reportTakeOver: 'Took over moderation report',
  reportResolve: 'Resolved moderation report',
  reportDismiss: 'Dismissed moderation report',
